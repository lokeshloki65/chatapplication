...
public class Server implements Runnable {
    ...
    private final Color statusWaitingColor = new Color(204, 153, 0);
    ...
    private void createGUI() {
        ...
        statusLabel = new JLabel("Waiting for Client", SwingConstants.LEFT);
        statusLabel.setFont(chatFont);
        statusLabel.setForeground(statusWaitingColor);
    ...
    private void sendMessage(String message) {
        if (message != null && !message.trim().isEmpty()) {
            try {
                ...
                appendMessage("You", message, serverStyle);
                inputField.setText("");
            } catch (IOException e) {
                e.printStackTrace();
            }
    ...
    public void run() {
        try {
            while (true) {
                ...
                appendMessage("Client", message, clientStyle);
            }
        } catch (IOException e) {
